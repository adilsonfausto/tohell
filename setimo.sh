#!/bin/bash
#
# setimo.sh - Nosso Setimo Programa em Shell - Laços de Repetição until
# Homepage: http://utah.com.br
# Autor: Adilson Fausto Silva
# Mantenedor: Grupo Utah
# ----------------------------------------------
#
# Este programa irá verificar o valor da variável NUMERO, enquanto o valor da variável não for 10, ele
# mostrará a mensagem na tela que o valor não é 10 e mostrará o valor da variável; quando o valor atingir
